...
void set_OscCurrent(String wec_type, float frequency, float amplitude) {
    ...
    if (wec_type == "PA") {
        if (frequency == 1.0) {
            if (amplitude == 0.1) {
                UART.setCurrent(2.98); 
            } else if (amplitude == 0.06) {
                UART.setCurrent(1.79); 
            } else if (amplitude == 0.02) {
                UART.setCurrent(0.60); 
            }
        } else if (frequency == 0.832) {
            if (amplitude == 0.1) {
                UART.setCurrent(3.74); 
            } else if (amplitude == 0.06) {
                UART.setCurrent(2.24); 
            } else if (amplitude == 0.02) {
                UART.setCurrent(0.75); 
            }
        } else if (frequency == 0.719) {
            if (amplitude == 0.1) {
                UART.setCurrent(4.29); 
            } else if (amplitude == 0.06) {
                UART.setCurrent(2.58); 
            } else if (amplitude == 0.02) {
                UART.setCurrent(0.86); 
            }
        }
    }
