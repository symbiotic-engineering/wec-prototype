...
mass_foam = density_foam * volume_foam*1.27;
...
buoyancy_force = density_water * volume_total * gravity

%% CALCULATING THE CURRENT CENTER OF MASS
center_of_mass = centroid+gap;
...
I_total = I_sheet + mass_sheet*centroid^2 + I_foam + mass_foam*centroid^2;
I_total = I_total + (mass_sheet+mass_foam)*(gap+centroid)^2
